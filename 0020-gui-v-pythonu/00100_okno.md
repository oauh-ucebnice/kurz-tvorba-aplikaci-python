...
## Další možnosti
- Můžeš upřesnit pozici levého horního rohu okna: `geometry("šířkaxvýška+levý_roh_x+levý_roh_Y")`:
  ```python
  geometry("600x400+100+80")
  ```

## Toto je pouze jednoduchý úvod!

Tento způsob používání oken je vhodný pouze pro malé aplikace s jedním oknem. Slouží zejména k demonstraci práce s widgety.

U větších aplikací je vhodnější využít *objektové programování* a rozdělit kód do tříd. To už je ale nad rámen našeho úvodního kurzu.

## Úkol
- Vytvoř aplikaci s oknem s rozměry 800x600 pixelů.
- Do titulkového pruhu umísti své jméno.
